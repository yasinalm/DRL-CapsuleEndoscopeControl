...
class GaussianMlpPolicy(object):
    def __init__(self, ob_dim, ac_dim):
        ...
        # double neuron
        h1 = tf.nn.elu(dense(ob_no, 32, "h1", weight_init=U.normc_initializer(1.0), bias_init=0.0, weight_loss_dict=wd_dict))
        mean_na = dense(h1, ac_dim, "mean", weight_init=U.normc_initializer(0.1), bias_init=0.0, weight_loss_dict=wd_dict)
